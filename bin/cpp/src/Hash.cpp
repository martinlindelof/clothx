...
Dynamic Hash_obj::iterator( ){
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< Dynamic > &it,Dynamic &__Internal){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Array< Dynamic >,it)
			bool run(){
{
					__SAFE_POINT
			...
			HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_2_2,Dynamic,__Internal,Array< Dynamic >,it)
			Dynamic run(){
{
					__SAFE_POINT
			...
			__result->Add(HX_CSTRING("next") ,  Dynamic(new _Function_2_2(__Internal,it)),true);
			return __result;
		}
	};

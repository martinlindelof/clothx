...
::clothx::physics::Spring_obj::__register();
...
::clothx::physics::RungeKuttaIntegrator_obj::__register();
::clothx::physics::ModifiedEulerIntegrator_obj::__register();
::clothx::physics::Attraction_obj::__register();
::clothx::physics::Force_obj::__register();
...
::clothx::physics::ParticleSystem_obj::__register();
...
::clothx::physics::Particle_obj::__register();
::nme::geom::Vector3D_obj::__register();
::nme::utils::IDataInput_obj::__register();
::nme::events::FocusEvent_obj::__register();
::nme::events::Event_obj::__register();
::clothx::physics::Integrator_obj::__register();
...
::clothx::physics::Integrator_obj::__boot();
::nme::events::Event_obj::__boot();
::nme::events::FocusEvent_obj::__boot();
::nme::utils::IDataInput_obj::__boot();
::nme::geom::Vector3D_obj::__boot();
::clothx::physics::Particle_obj::__boot();
...
::clothx::physics::ParticleSystem_obj::__boot();
...
::clothx::physics::Force_obj::__boot();
::clothx::physics::Attraction_obj::__boot();
::clothx::physics::ModifiedEulerIntegrator_obj::__boot();
::clothx::physics::RungeKuttaIntegrator_obj::__boot();
::IntHash_obj::__boot();
...
::clothx::physics::Spring_obj::__boot();

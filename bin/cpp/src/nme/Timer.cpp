...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",16)
	this->mTime = time;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",17)
	::nme::Timer_obj::sRunningTimers->push(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",18)
	this->mFireAt = (::nme::Timer_obj::GetMS() + this->mTime);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",19)
	this->mRunning = true;
}
;
	return null();
...
Void Timer_obj::stop( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",26)
		if ((this->mRunning)){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",29)
			this->mRunning = false;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",30)
...
Void Timer_obj::nmeCheck( double inTime){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",51)
		if (((inTime >= this->mFireAt))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",54)
			hx::AddEq(this->mFireAt,this->mTime);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",55)
			this->run();
		}
	}
return null();
...
double Timer_obj::nmeNextWake( double limit){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",36)
	double now = (::nme::Timer_obj::nme_time_stamp() * 1000.0);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",37)
	{
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",37)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",37)
			++(_g);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",39)
			double sleep = (timer->mFireAt - now);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",40)
			if (((sleep < limit))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",42)
				limit = sleep;
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",43)
				if (((limit < (int)0))){
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",43)
					return (int)0;
				}
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",47)
	return limit;
}
...
Void Timer_obj::nmeCheckTimers( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",61)
		double now = ::nme::Timer_obj::GetMS();
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",62)
		{
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",62)
			int _g = (int)0;
			Array< ::nme::Timer > _g1 = ::nme::Timer_obj::sRunningTimers;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",62)
				++(_g);
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",63)
				timer->nmeCheck(now);
			}
		}
	}
...
double Timer_obj::GetMS( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",67)
...
::nme::Timer Timer_obj::delay( Dynamic f,int time){
	__SAFE_POINT
	HX_SOURCE_PUSH("Timer_obj::delay")
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",73)
	Array< Dynamic > f1 = Array_obj< Dynamic >::__new().Add(f);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",74)
	Array< ::nme::Timer > t = Array_obj< ::nme::Timer >::__new().Add(::nme::Timer_obj::__new(time));

	HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_1_1,Array< ::nme::Timer >,t,Array< Dynamic >,f1)
	Void run(){
{
			__SAFE_POINT
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",76)
			t->__get((int)0)->stop();
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",77)
			f1->__get((int)0)().Cast< Void >();
		}
		return null();
	}
	HX_END_LOCAL_FUNC0((void))

	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",75)
	t->__get((int)0)->run =  Dynamic(new _Function_1_1(t,f1));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",79)
...
double Timer_obj::stamp( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/Timer.hx",84)

...
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",45)
	int fill_col;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",46)
	int fill_alpha;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",48)
	if (((inFillRGBA == null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",50)
		fill_col = (int)16777215;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",51)
		fill_alpha = (int)255;
	}
	else{
		struct _Function_2_1{
			inline static int Block( Dynamic &inFillRGBA){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",55)
				int v = inFillRGBA;
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",55)
		...
		struct _Function_2_2{
			inline static int Block( Dynamic &inFillRGBA){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",56)
				int v = inFillRGBA;
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",56)
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",59)
	if (((bool((inWidth < (int)1)) || bool((inHeight < (int)1))))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",59)
		this->nmeHandle = null();
	}
	else{
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",64)
		int flags = ::nme::display::BitmapData_obj::HARDWARE;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",65)
		if ((inTransparent)){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",66)
			hx::OrEq(flags,::nme::display::BitmapData_obj::TRANSPARENT);
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",67)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",107)
...
Void BitmapData_obj::clear( int color){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",115)
...
::nme::display::BitmapData BitmapData_obj::clone( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",120)
	::nme::display::BitmapData bm = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",121)
	bm->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_clone(this->nmeHandle);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",122)
	return bm;
}
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",127)
...
Void BitmapData_obj::copyChannel( ::nme::display::BitmapData sourceBitmapData,::nme::geom::Rectangle sourceRect,::nme::geom::Point destPoint,int inSourceChannel,int inDestChannel){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",133)
...
Void BitmapData_obj::applyFilter( ::nme::display::BitmapData sourceBitmapData,::nme::geom::Rectangle sourceRect,::nme::geom::Point destPoint,::nme::filters::BitmapFilter filter){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",140)
...
Void BitmapData_obj::colorTransform( ::nme::geom::Rectangle rect,::nme::geom::ColorTransform colorTransform){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",145)
...
Void BitmapData_obj::dispose( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",152)
		this->nmeHandle = null();
	}
return null();
}
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",162)
...
Void BitmapData_obj::fillRect( ::nme::geom::Rectangle rect,int inColour){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",169)
		int a = hx::UShr(inColour,(int)24);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",170)
		int c = (int(inColour) & int((int)16777215));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",171)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",175)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",182)
		::nme::geom::Rectangle result = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",183)
		::nme::display::BitmapData_obj::nme_bitmap_data_get_color_bounds_rect(this->nmeHandle,mask,color,findColor,result);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",184)
		return result;
	}
}
...
::nme::utils::ByteArray BitmapData_obj::getPixels( ::nme::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",190)
	::nme::utils::ByteArray result = ::nme::display::BitmapData_obj::nme_bitmap_data_get_pixels(this->nmeHandle,rect);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",191)
	if (((result != null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",192)
		result->position = result->length;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",193)
	return result;
}
...
Array< int > BitmapData_obj::getVector( ::nme::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",198)
	int pixels = ::Std_obj::_int((rect->width * rect->height));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",199)
	if (((pixels < (int)1))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",200)
		return Array_obj< int >::__new();
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",201)
	Array< int > result = Array_obj< int >::__new();
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",202)
	result[(pixels - (int)1)] = (int)0;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",205)
	::nme::display::BitmapData_obj::nme_bitmap_data_get_array(this->nmeHandle,rect,result);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",213)
	return result;
}
...
int BitmapData_obj::getPixel( int x,int y){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",219)
...
int BitmapData_obj::getPixel32( int x,int y){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",224)
...
Void BitmapData_obj::scroll( int inDX,int inDY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",237)
...
Void BitmapData_obj::setPixel32( int inX,int inY,int inColour){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",242)
...
Void BitmapData_obj::setPixel( int inX,int inY,int inColour){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",250)
...
::nme::geom::Rectangle BitmapData_obj::generateFilterRect( ::nme::geom::Rectangle sourceRect,::nme::filters::BitmapFilter filter){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",256)
	::nme::geom::Rectangle result = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",257)
	::nme::display::BitmapData_obj::nme_bitmap_data_generate_filter_rect(sourceRect,filter,result);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",258)
	return result;
}
...
Void BitmapData_obj::setPixels( ::nme::geom::Rectangle rect,::nme::utils::ByteArray pixels){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",264)
		int size = ::Std_obj::_int(((rect->width * rect->height) * (int)4));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",265)
		pixels->checkData(::Std_obj::_int(size));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",266)
		::nme::display::BitmapData_obj::nme_bitmap_data_set_bytes(this->nmeHandle,rect,pixels,pixels->position);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",267)
...
Void BitmapData_obj::setVector( ::nme::geom::Rectangle rect,Array< int > inPixels){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",273)
		int count = ::Std_obj::_int((rect->width * rect->height));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",274)
		if (((inPixels->length < count))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",275)
			return null();
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",278)
...
Void BitmapData_obj::nmeDrawToSurface( Dynamic inSurface,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,bool smoothing){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",299)
...
Void BitmapData_obj::setFlags( int inFlags){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",307)
...
::nme::geom::Rectangle BitmapData_obj::nmeGetRect( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",315)
...
int BitmapData_obj::nmeGetWidth( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",316)
...
int BitmapData_obj::nmeGetHeight( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",317)
...
bool BitmapData_obj::nmeGetTransparent( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",318)
...
::nme::display::BitmapData BitmapData_obj::load( ::String inFilename){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",79)
	::nme::display::BitmapData result = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",80)
	result->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_load(inFilename);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",81)
	return result;
}
...
::nme::display::BitmapData BitmapData_obj::loadFromBytes( ::nme::utils::ByteArray inBytes,::nme::utils::ByteArray inRawAlpha){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",94)
	::nme::display::BitmapData result = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",95)
	result->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_from_bytes(inBytes,inRawAlpha);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",96)
	return result;
}
...
Dynamic BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes inBytes,::haxe::io::Bytes inRawAlpha){
	__SAFE_POINT
	HX_SOURCE_PUSH("BitmapData_obj::loadFromHaxeBytes")
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",101)
	return ::nme::display::BitmapData_obj::loadFromHaxeBytes(::nme::utils::ByteArray_obj::fromBytes(inBytes),(  (((inRawAlpha == null()))) ? ::nme::utils::ByteArray(::nme::utils::ByteArray_obj::fromBytes(inRawAlpha)) : ::nme::utils::ByteArray(null()) ));
}
...
int BitmapData_obj::extractAlpha( int v){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",323)
	return hx::UShr(v,(int)24);
}
...
int BitmapData_obj::extractColor( int v){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",332)
	return (int(v) & int((int)16777215));
}
...
{
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/BitmapData.hx",341)

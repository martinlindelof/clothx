...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",10)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",15)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",21)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",27)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",42)
		if (((matrix == null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",44)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",45)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",47)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",63)
		if (((matrix == null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",65)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",66)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",68)
...
Void Graphics_obj::endFill( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",77)
...
Void Graphics_obj::clear( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",82)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",89)
...
Void Graphics_obj::moveTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",101)
...
Void Graphics_obj::lineTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",106)
...
Void Graphics_obj::curveTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",111)
...
Void Graphics_obj::arcTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",116)
...
Void Graphics_obj::drawEllipse( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",121)
...
Void Graphics_obj::drawCircle( double inX,double inY,double inRadius){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",126)
...
Void Graphics_obj::drawRect( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",131)
...
Void Graphics_obj::drawRoundRect( double inX,double inY,double inWidth,double inHeight,double inRadX,Dynamic inRadY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",137)
...
Void Graphics_obj::drawTriangles( Array< double > vertices,Array< int > indices,Array< double > uvtData,::nme::display::TriangleCulling culling){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",147)
		int cull = (  (((culling == null()))) ? int((int)0) : int((culling->__Index() - (int)1)) );
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",149)
...
Void Graphics_obj::drawGraphicsData( Array< ::nme::display::IGraphicsData > graphicsData){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",155)
		Array< Dynamic > handles = Array_obj< Dynamic >::__new();
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",156)
		{
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",156)
			int _g = (int)0;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",156)
			while(((_g < graphicsData->length))){
				...
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",156)
				++(_g);
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",157)
				handles->push(datum->nmeHandle);
			}
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",158)
...
Void Graphics_obj::drawGraphicsDatum( ::nme::display::IGraphicsData graphicsDatum){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",162)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",168)
		this->beginBitmapFill(sheet->nmeBitmap,null(),false,inSmooth);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",169)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",182)
...
{
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Graphics.hx",173)

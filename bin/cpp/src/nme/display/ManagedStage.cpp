...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",47)
...
Void ManagedStage_obj::resize( int inWidth,int inHeight){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",52)
...
Void ManagedStage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",58)
		this->beginRender();
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",59)
		this->super::nmeRender(inSendEnterFrame);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",60)
		this->endRender();
	}
return null();
}
...
double ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",65)
	this->nmePollTimers();
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",66)
	double wake = this->super::nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",67)
	this->setNextWake(wake);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",68)
	return wake;
}
...
Void ManagedStage_obj::pumpEvent( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",72)
...
Void ManagedStage_obj::sendQuit( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/ManagedStage.hx",77)

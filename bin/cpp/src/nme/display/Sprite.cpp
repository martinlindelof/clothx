...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",6)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",11)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",13)
...
Void Sprite_obj::stopDrag( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",17)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",19)
...
::String Sprite_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/display/Sprite.hx",21)

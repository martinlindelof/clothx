...
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/ErrorEvent.hx",10)
	super::__construct(type,bubbles,cancelable,text);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/ErrorEvent.hx",11)
	this->errorID = inID;
}
;
	return null();
...
::String ErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/ErrorEvent.hx",14)
	return this->text;
}

...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",47)
	this->nmeTarget = (  (((target == null()))) ? ::nme::events::IEventDispatcher(hx::ObjectPtr<OBJ_>(this)) : ::nme::events::IEventDispatcher(target) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",48)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",55)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",56)
			this->nmeEventMap = ::Hash_obj::__new();
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",57)
		Array< ::nme::events::Listener > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",58)
		if (((list == null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",60)
			list = Array_obj< ::nme::events::Listener >::__new();
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",61)
			this->nmeEventMap->set(type,list);
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",64)
		::nme::events::Listener l = ::nme::events::Listener_obj::__new(listener,useCapture,priority);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",65)
		list->push(l);
	}
return null();
}
...
bool EventDispatcher_obj::dispatchEvent( ::nme::events::Event event){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",70)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",71)
		return false;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",72)
	if (((event->target == null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",73)
		event->target = this->nmeTarget;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",74)
	Array< ::nme::events::Listener > list = this->nmeEventMap->get(event->type);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",75)
	bool capture = (event->eventPhase == ::nme::events::EventPhase_obj::CAPTURING_PHASE);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",76)
	if (((list != null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",78)
		int idx = (int)0;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",79)
		while(((idx < list->length))){
			__SAFE_POINT
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",81)
			::nme::events::Listener listener = list->__get(idx);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",82)
			if (((listener->mUseCapture == capture))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",84)
				listener->dispatchEvent(event);
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",85)
				if ((event->nmeGetIsCancelledNow())){
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",86)
					return true;
				}
			}
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",89)
			if (((bool((idx < list->length)) && bool((listener != list->__get(idx)))))){
			}
			else{
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",94)
				(idx)++;
			}
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",96)
		return true;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",99)
	return false;
}
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",103)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",104)
		return false;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",105)
...
{
		__SAFE_POINT
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",109)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",110)
			return null();
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",112)
		if ((!(this->nmeEventMap->exists(type)))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",112)
			return null();
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",114)
		Array< ::nme::events::Listener > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",115)
		{
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",115)
			int _g1 = (int)0;
			int _g = list->length;
			...
			while(((_g1 < _g))){
				...
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",115)
				int i = (_g1)++;
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",117)
				if ((list->__get(i)->Is(listener,capture))){
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",119)
					list->splice(i,(int)1);
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",120)
					return null();
				}
			}
		}
...
bool EventDispatcher_obj::willTrigger( ::String type){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",127)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",128)
		return false;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",129)
	return this->nmeEventMap->exists(type);
}
...
Void EventDispatcher_obj::DispatchCompleteEvent( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",137)
		::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null());
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",138)
...
Void EventDispatcher_obj::DispatchIOErrorEvent( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",145)
		::nme::events::IOErrorEvent evt = ::nme::events::IOErrorEvent_obj::__new(::nme::events::IOErrorEvent_obj::IO_ERROR,null(),null(),null(),null());
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/EventDispatcher.hx",146)
		this->dispatchEvent(evt);
	}
return null();
}

...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",18)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",20)
	this->keyCode = inKeyCode;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",21)
	this->keyLocation = (  (((inKeyLocation == null()))) ? Dynamic((int)0) : Dynamic(inKeyLocation) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",22)
	this->charCode = (  (((inCharCode == null()))) ? Dynamic((int)0) : Dynamic(inCharCode) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",24)
	this->shiftKey = (  (((inShiftKey == null()))) ? Dynamic(false) : Dynamic(inShiftKey) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",25)
	this->altKey = (  (((inAltKey == null()))) ? Dynamic(false) : Dynamic(inAltKey) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/KeyboardEvent.hx",26)

...
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/TextEvent.hx",10)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/events/TextEvent.hx",11)
	this->text = inText;
}
;
	return null();

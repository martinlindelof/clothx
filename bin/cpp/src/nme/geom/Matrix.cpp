...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",31)
	this->a = (  (((in_a == null()))) ? Dynamic(1.0) : Dynamic(in_a) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",32)
	this->b = (  (((in_b == null()))) ? Dynamic(0.0) : Dynamic(in_b) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",33)
	this->c = (  (((in_c == null()))) ? Dynamic(0.0) : Dynamic(in_c) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",34)
	this->d = (  (((in_d == null()))) ? Dynamic(1.0) : Dynamic(in_d) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",35)
	this->tx = (  (((in_tx == null()))) ? Dynamic(0.0) : Dynamic(in_tx) );
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",36)
...
::nme::geom::Matrix Matrix_obj::clone( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",40)
...
Void Matrix_obj::createGradientBox( double in_width,double in_height,Dynamic rotation,Dynamic in_tx,Dynamic in_ty){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",45)
		this->a = (double(in_width) / double(1638.4));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",46)
		this->d = (double(in_height) / double(1638.4));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",49)
		if (((bool((rotation != null())) && bool((rotation != 0.0))))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",51)
			double cos = ::Math_obj::cos(rotation);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",52)
			double sin = ::Math_obj::sin(rotation);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",53)
			this->b = (sin * this->d);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",54)
			this->c = (-(sin) * this->a);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",55)
			hx::MultEq(this->a,cos);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",56)
			hx::MultEq(this->d,cos);
		}
		else{
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",59)
			this->b = this->c = (int)0;
		}
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",63)
		this->tx = (  (((in_tx != null()))) ? double((in_tx + (double(in_width) / double((int)2)))) : double((double(in_width) / double((int)2))) );
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",64)
...
Void Matrix_obj::setRotation( double inTheta,Dynamic inScale){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",69)
		double scale = (  (((inScale == null()))) ? Dynamic(1.0) : Dynamic(inScale) );
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",70)
		this->a = (::Math_obj::cos(inTheta) * scale);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",71)
		this->c = (::Math_obj::sin(inTheta) * scale);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",72)
		this->b = -(this->c);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",73)
		this->d = this->a;
	}
return null();
}
...
Void Matrix_obj::identity( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",77)
		this->a = (int)1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",77)
		this->b = (int)0;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",77)
...
::nme::geom::Matrix Matrix_obj::invert( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",82)
	double norm = ((this->a * this->d) - (this->b * this->c));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",83)
	if (((norm == (int)0))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",85)
		this->a = this->b = this->c = this->d = (int)0;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",86)
		this->tx = -(this->tx);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",87)
		this->ty = -(this->ty);
	}
	else{
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",91)
		norm = (double(1.0) / double(norm));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",92)
		double a1 = (this->d * norm);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",93)
		this->d = (this->a * norm);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",94)
		this->a = a1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",95)
		hx::MultEq(this->b,-(norm));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",96)
		hx::MultEq(this->c,-(norm));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",98)
		double tx1 = ((-(this->a) * this->tx) - (this->c * this->ty));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",99)
		this->ty = ((-(this->b) * this->tx) - (this->d * this->ty));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",100)
		this->tx = tx1;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",102)
...
::nme::geom::Point Matrix_obj::transformPoint( ::nme::geom::Point inPos){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",106)
...
Void Matrix_obj::translate( double inDX,double inDY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",113)
		hx::AddEq(this->tx,inDX);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",114)
...
Void Matrix_obj::rotate( double inTheta){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",134)
		double cos = ::Math_obj::cos(inTheta);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",135)
		double sin = ::Math_obj::sin(inTheta);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",137)
		double a1 = ((this->a * cos) - (this->b * sin));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",138)
		this->b = ((this->a * sin) + (this->b * cos));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",139)
		this->a = a1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",141)
		double c1 = ((this->c * cos) - (this->d * sin));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",142)
		this->d = ((this->c * sin) + (this->d * cos));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",143)
		this->c = c1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",145)
		double tx1 = ((this->tx * cos) - (this->ty * sin));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",146)
		this->ty = ((this->tx * sin) + (this->ty * cos));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",147)
		this->tx = tx1;
	}
return null();
}
...
Void Matrix_obj::scale( double inSX,double inSY){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",162)
		hx::MultEq(this->a,inSX);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",163)
		hx::MultEq(this->b,inSY);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",165)
		hx::MultEq(this->c,inSX);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",166)
		hx::MultEq(this->d,inSY);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",168)
		hx::MultEq(this->tx,inSX);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",169)
...
Void Matrix_obj::concat( ::nme::geom::Matrix m){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",192)
		double a1 = ((this->a * m->a) + (this->b * m->c));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",193)
		this->b = ((this->a * m->b) + (this->b * m->d));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",194)
		this->a = a1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",196)
		double c1 = ((this->c * m->a) + (this->d * m->c));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",197)
		this->d = ((this->c * m->b) + (this->d * m->d));
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",198)
		this->c = c1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",200)
		double tx1 = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",201)
		this->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",202)
		this->tx = tx1;
	}
return null();
}
...
::nme::geom::Matrix Matrix_obj::mult( ::nme::geom::Matrix m){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",207)
	::nme::geom::Matrix result = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",208)
	result->a = ((this->a * m->a) + (this->b * m->c));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",209)
	result->b = ((this->a * m->b) + (this->b * m->d));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",210)
	result->c = ((this->c * m->a) + (this->d * m->c));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",211)
	result->d = ((this->c * m->b) + (this->d * m->d));
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",213)
	result->tx = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",214)
	result->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/geom/Matrix.hx",215)
	return result;
}

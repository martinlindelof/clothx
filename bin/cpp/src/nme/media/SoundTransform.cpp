...
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/media/SoundTransform.hx",10)
	this->volume = vol;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/media/SoundTransform.hx",11)
	this->pan = panning;
}
;
	return null();
...
::nme::media::SoundTransform SoundTransform_obj::clone( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/media/SoundTransform.hx",14)

...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",49)
	super::__construct(null());
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",50)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",51)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",52)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",53)
	this->state = (int)0;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",54)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",55)
	if (((request != null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",56)
		this->load(request);
	}
}
;
...
Void URLLoader_obj::load( ::nme::net::URLRequest request){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",63)
		this->state = (int)1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",64)
		::String pref = request->url.substr((int)0,(int)7);
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",65)
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",67)
			try{
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",68)
				::nme::utils::ByteArray bytes = ::nme::utils::ByteArray_obj::readFile(request->url);
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",69)
				{
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
					switch((_switch_1)->GetIndex()){
						case 1: case 2: {
							HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",71)
							this->data = bytes->asString();
						}
						;break;
						default: {
							HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",73)
							this->data = bytes;
						}
					}
				}
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",77)
						this->onError(e);
						HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",78)
						return null();
					}
				}
			}
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",80)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
		else{
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",84)
			...
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",86)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",87)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",91)
...
Void URLLoader_obj::update( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",98)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",101)
			int old_state = this->state;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",102)
			int old_loaded = this->bytesLoaded;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",103)
			int old_total = this->bytesTotal;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",104)
			::nme::net::URLLoader_obj::nme_curl_update_loader(this->nmeHandle,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",105)
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",106)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::OPEN,null(),null()));
			}
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",110)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",111)
				this->dispatchEvent(::nme::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",115)
			int code = ::nme::net::URLLoader_obj::nme_curl_get_code(this->nmeHandle);
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",116)
			if (((this->state == (int)3))){
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",117)
				if (((code < (int)400))){
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",120)
					::nme::utils::ByteArray bytes = ::nme::net::URLLoader_obj::nme_curl_get_data(this->nmeHandle);
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",121)
					{
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
						switch((_switch_2)->GetIndex()){
							case 1: case 2: {
								HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",123)
								this->data = (  (((bytes == null()))) ? ::String(HX_CSTRING("")) : ::String(bytes->asString()) );
							}
							;break;
							default: {
								HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",125)
								this->data = bytes;
							}
						}
					}
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",128)
					this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
				}
				else{
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",133)
					...
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",138)
					this->nmeHandle = null();
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",139)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",142)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",144)
					...
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",149)
					this->nmeHandle = null();
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",150)
					this->dispatchEvent(evt);
				}
			}
		}
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",172)
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",177)
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",95)
...
Void URLLoader_obj::nmePollData( ){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",156)
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",159)
			::nme::net::URLLoader_obj::nme_curl_process_loaders();
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",160)
			::List oldLoaders = ::nme::net::URLLoader_obj::activeLoaders;
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",161)
			::nme::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",162)
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",164)
					loader->update();
					HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",165)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",166)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",181)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLLoader.hx",184)

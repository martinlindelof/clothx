...
{
{
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",21)
	if (((inURL != null()))){
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",22)
		this->url = inURL;
	}
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",23)
	this->verbose = false;
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",24)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",25)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",26)
	this->authType = (int)0;
}
;
	return null();
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",31)
		this->authType = (int)1;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",32)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",37)
		this->authType = (int)2;
		HX_SOURCE_POS("/Users/martin/Documents/haxelib/nekonme/nme/net/URLRequest.hx",38)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
